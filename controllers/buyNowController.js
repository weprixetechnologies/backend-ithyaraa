    ...
    try {
        ...
        if (productType === 'presale') {
            ...
            const [detailResult] = await connection.query(
                ...
                [
                    uid,
                    shippingSnapshot.shippingLine1 || '',
                    shippingSnapshot.shippingLine2 || '',
                    shippingSnapshot.shippingPincode || '',
                    shippingSnapshot.shippingLandmark || '',
                    shippingSnapshot.shippingState || '',
